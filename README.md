## DeepCplus : Open Source Deep Learning Server & API


DeepCplus  is a machine learning API and server written in C++11. It makes state of the art machine learning easy to work with and integrate into existing applications.

DeepCplus relies on external machine learning libraries through a very generic and flexible API. At the moment it has support for:
...
DeepCplus implements support for supervised and unsupervised deep learning of images, text and other data, with focus on simplicity and ease of use, test and connection into existing applications. It supports classification, object detection, segmentation, regression, autoencoders, ...

#### Support

Please join either the community on [Gitter](https://gitter.im/beniz/DeepCplus) or on IRC Freenode #DeepCplus, where we help users get through with installation, API, neural nets and connection to external applications.
...
- **docker images** for CPU and GPU machines are available at https://hub.docker.com/r/jolibrain/DeepCplus_cpu/ and https://hub.docker.com/r/jolibrain/DeepCplus_gpu/ respectively. See https://github.com/jolibrain/DeepCplus/tree/master/docker/README.md for details on how to use them.

- For **Amazon AMI** see official builds documentation at https://DeepCplus.com/products/ami/, and direct links to [GPU AMI](https://aws.amazon.com/marketplace/pp/B01N4D483M) and [CPU AMI](https://aws.amazon.com/marketplace/pp/B01N1RGWQZ).
...
#### Tutorials
List of tutorials, training from text, data and images, setup of prediction services, and export to external software (e.g. ElasticSearch) 
...
- Log DeepCplus training metrics via Tensorboard with [dd_board](https://github.com/jolibrain/dd_board)
...
By default DeepCplus automatically relies on a modified version of Caffe, https://github.com/jolibrain/caffe/tree/master
...
| SqueezeNet               | [Y](https://DeepCplus.com/models/squeezenet/squeezenet_v1.1.caffemodel)     | N          | DeepScale              |       59.5%                    | 
| Inception v1 / GoogleNet | [Y](https://DeepCplus.com/models/ggnet/bvlc_googlenet.caffemodel)     | [Y](https://DeepCplus.com/models/tf/inception_v1.pb)          | BVLC / Google |             67.9%              |
| Inception v2             | N     | [Y](https://DeepCplus.com/models/tf/inception_v2.pb)          | Google        |     72.2%                      |
| Inception v3             | N     | [Y](https://DeepCplus.com/models/tf/inception_v3.pb)          | Google        |         76.9%                  |
| Inception v4             | N     | [Y](https://DeepCplus.com/models/tf/inception_v4.pb)          | Google        |         80.2%                  |
| ResNet 50                | [Y](https://DeepCplus.com/models/resnet/ResNet-50-model.caffemodel)     | [Y](https://DeepCplus.com/models/tf/resnet_v1_50/resnet_v1_50.pb)          | MSR           |      75.3%                     |
| ResNet 101               | [Y](https://DeepCplus.com/models/resnet/ResNet-101-model.caffemodel)     | [Y](https://DeepCplus.com/models/tf/resnet_v1_101/resnet_v1_101.pb)          | MSR           |        76.4%                   |
| ResNet 152               | [Y](https://DeepCplus.com/models/resnet/ResNet-152-model.caffemodel)     | [Y](https://DeepCplus.com/models/tf/resnet_v1_152/resnet_v1_152.pb)         | MSR           |               77%            |
| Inception-ResNet-v2      | N     | [Y](https://DeepCplus.com/models/tf/inception_resnet_v2.pb)          | Google        |       79.79%                    |
| VGG-16                   | [Y](https://DeepCplus.com/models/vgg_16/VGG_ILSVRC_16_layers.caffemodel)     | [Y](https://DeepCplus.com/models/tf/vgg_16/vgg_16.pb)          | Oxford        |               70.5%            |
| VGG-19                   | [Y](https://DeepCplus.com/models/vgg_19/VGG_ILSVRC_19_layers.caffemodel)     | [Y](https://DeepCplus.com/models/tf/vgg_19/vgg_19.pb)          | Oxford        |               71.3%            |
| ResNext 50                | [Y](https://DeepCplus.com/models/resnext/resnext_50)     | N          | https://github.com/terrychenism/ResNeXt           |      76.9%                     |
| ResNext 101                | [Y](https://DeepCplus.com/models/resnext/resnext_101)     | N          | https://github.com/terrychenism/ResNeXt           |      77.9%                     |
| ResNext 152               | [Y](https://DeepCplus.com/models/resnext/resnext_152)     | N          | https://github.com/terrychenism/ResNeXt           |      78.7%                     |
| DenseNet-121                   | [Y](https://DeepCplus.com/models/densenet/densenet_121_32/)     | N          | https://github.com/shicai/DenseNet-Caffe        |               74.9%            |
| DenseNet-161                   | [Y](https://DeepCplus.com/models/densenet/densenet_161_48/)     | N          | https://github.com/shicai/DenseNet-Caffe        |               77.6%            |
| DenseNet-169                   | [Y](https://DeepCplus.com/models/densenet/densenet_169_32/)     | N          | https://github.com/shicai/DenseNet-Caffe        |               76.1%            |
| DenseNet-201                   | [Y](https://DeepCplus.com/models/densenet/densenet_201_32/)     | N          | https://github.com/shicai/DenseNet-Caffe        |               77.3%            |
| SE-BN-Inception                   | [Y](https://DeepCplus.com/models/senets/se_bn_inception/)     | N          | https://github.com/hujie-frank/SENet        |               76.38%            |
| SE-ResNet-50                   | [Y](https://DeepCplus.com/models/senets/se_resnet_50/)     | N          | https://github.com/hujie-frank/SENet        |               77.63%            |
| SE-ResNet-101                   | [Y](https://DeepCplus.com/models/senets/se_resnet_101/)     | N          | https://github.com/hujie-frank/SENet        |               78.25%            |
| SE-ResNet-152                   | [Y](https://DeepCplus.com/models/senets/se_resnet_152/)     | N          | https://github.com/hujie-frank/SENet        |               78.66%            |
| SE-ResNext-50                   | [Y](https://DeepCplus.com/models/senets/se_resnext_50/)     | N          | https://github.com/hujie-frank/SENet        |               79.03%            |
| SE-ResNext-101                   | [Y](https://DeepCplus.com/models/senets/se_resnext_101/)     | N          | https://github.com/hujie-frank/SENet        |               80.19%            |
| SENet                   | [Y](https://DeepCplus.com/models/senets/se_net/)     | N          | https://github.com/hujie-frank/SENet        |               81.32%            |
| VOC0712 (object detection) | [Y](https://DeepCplus.com/models/voc0712_dd.tar.gz) | N | https://github.com/weiliu89/caffe/tree/ssd | 71.2 mAP |
| InceptionBN-21k | [Y](https://DeepCplus.com/models/inception/inception_bn_21k) | N | https://github.com/pertusa/InceptionBN-21K-for-Caffe | 41.9% |
| Inception v3 5K | N | [Y](https://DeepCplus.com/models/tf/openimages_inception_v3) | https://github.com/openimages/dataset |  |
...
- List of free, even for commercial use, deep neural nets for image classification, and character-based convolutional nets for text classification 

#### Templates

DeepCplus comes with a built-in system of neural network templates (Caffe backend only at the moment). This allows the creation of custom networks based on recognized architectures, for images, text and data, and with much simplicity.
...
Below are instructions for Ubuntu 14.04 LTS and 16.04 LTS. For other Linux and Unix systems, steps may differ, CUDA, Caffe and other libraries may prove difficult to setup. If you are building on 16.04 LTS.
...
```
- linked into another executable. To build only the library (and use a `dd::DeepCplus<dd::JSonAPI>` object in your own code) use:
```
...
Caffe remains the default backend for DeepCplus though it can be deactivated with cmake. However, at least one library needs to be specified:
```
...
DeepCplus [ commit 73d4e638498d51254862572fe577a21ab8de2ef1 ]
Running DeepCplus HTTP server on localhost:8080
```
...
To use DeepCplus without the client/server architecture while passing the exact same JSON messages from the API:
...
```
./dede --jsonapi 1 --service_name test --service_create '{"mllib":"caffe","description":"classification service","type":"supervised","parameters":{"input":{"connector":"image"},"mllib":{"template":"googlenet","nclasses":10}},"model":{"templates":"/path/to/DeepCplus/templates/caffe/","repository":"/path/to/model/"}}'
```
